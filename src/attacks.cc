...
AttackLib::Attack AttackLib::lib[] = {
	...
	{"Fight",		NULL,			&fight_ani,		-1,		true, 	false,	false,	false,	true,	false,	false,	-1,		NONE,	SELF + FRIEND + ENEMY + SINGLE},
	{"Battle",		NULL,			NULL,			-1,		true, 	false,	false,	false,	true,	false,	false,	-1,		NONE,	SELF + FRIEND + ENEMY + SINGLE},
